[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=9796485&assignment_repo_type=AssignmentRepo)
# Séries de Dados
...
> Dados de um pet shoop: Quantidade de cães e gatos consultados no pet shoop  
...
> Não, a pessoa que desenvolveu esse código já tinha definido o tipo de esperado que era no caso era o de inteiros. 
...
> Usando uma interface, que com ela foi possível sobrescrever seus métodos, e se caso essa classe não sobrescreva esses métodos ela irá se tornar uma classe abstrada, fazendo com que as suas subclasses sobrescrevão os métodos da interface.Com isso foi possível plotar o gráfico.

3. O que o polimorfismo tem a ver com o que foi feito?

> Com a interface SerieDados foi possível acessar os dados da classe SerieDadosPetShoop, possibilitando a capacidade desta interface de mudar de acordo com as classes que a implementam desde que sobrescrevam seus métodos.

4. Para que então servem as interfaces (como tipo de dado)?

> Elas definem um tipo de comportamento que as classes implementam tenha que seguir, para com isso sempre garantir que os objetos criados respeitem suas definiçóes.
